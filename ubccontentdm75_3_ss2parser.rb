...
class Ubccontentdm753Ss2parser < SupplejackCommon::Json::Base
	  ...
	  base_url "https://praeclusio.nyc3.cdn.digitaloceanspaces.com/ParserData/UBC/CONTENTDM/dm75_2ss2yxphoenixToalderstar.json"
    ...
    "TextLegal works" => "Other",
    "TextDiaries" => "Book",
    "TextAdvertising cards" => "Image",
    "TextFieldnotes" => "Other",
    ...
    "TextCatalogs" => "Other",
    "TextPeriodicals" => "Other",
    /Text$/ => "Newspaper",
		"TextBroadsides" => "Other",
		"TextProclamations" => "Other",
		"TextYearbooks" => "Book",
		"TextContracts"	 => "Other",
		"TextBills" => "Other",
		"TextPamphlets" => 	"Other",
  ...
  #reject the 502 errored record 
   	reject_if do
		     get(:thumbnail_url).find_with("https://open.library.ubc.ca/img/thumbnails/cdm/bbmnhibc/200/1.0420564").present?
	    end

...
class Ubccontentdm753Ss6parser < SupplejackCommon::Json::Base
	  ...
	  base_url "https://praeclusio.nyc3.cdn.digitaloceanspaces.com/ParserData/UBC/CONTENTDM/ubccontentdm75_3Subset6.json"
	...
	#)
	  ...
	  #attribute :genre, path: "$.Genre[0]['@value']"
		...
		attribute :category, default: "Other"  

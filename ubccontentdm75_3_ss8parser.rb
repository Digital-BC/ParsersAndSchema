...
class Ubccontentdm753Ss8parser < SupplejackCommon::Json::Base
	  ...
	  base_url "https://praeclusio.nyc3.cdn.digitaloceanspaces.com/ParserData/UBC/CONTENTDM/ubccontentdm75_3Subset8a.json"
	...
	#   reject_if do
	  ...
	  #  thumbnail_url = "https://praeclusio.nyc3.cdn.digitaloceanspaces.com/Icons/document.svg" if get(:source_url).find_with(/.*1.0115966.*/).present?
  	  ...
  	  reject_if do
	     ...
	     #broken DOI
	     get(:thumbnail_url).find_with("https://open.library.ubc.ca/img/thumbnails/cdm/arphotos/200/1.0153461").present?
